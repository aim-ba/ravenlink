  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-700 dark:bg-gray-900">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50 dark:bg-gray-800">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">The Raven Link<sup className="text-sm font-normal align-super">®</sup> Process</h2>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
            Learn more about how Raven Link<sup className="text-xs font-normal align-super">®</sup> can help your organization build stronger Indigenous partnerships
