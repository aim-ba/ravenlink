...
export function Features() {
  ...
  return (
    <section ref={ref} className="py-26 px-4 sm:px-6 lg:px-8 bg-background">
            ...
            return (
              ...
              >
                <Card
                  ...
                  style={{
                    borderColor: hoveredIndex === index ? `var(--${pillar.chartColor})` : undefined
                  }}
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 space-y-2">
                      <div className="flex items-center gap-2">
                        <Icon
                          className="w-4 h-4"
                          style={{ color: `var(--${pillar.chartColor})` }}
                        />
